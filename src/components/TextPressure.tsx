...
const TextPressure = ({
  // CHANGED DEFAULT: Removed 'Rubayet', set to 'Front-End Engineer'
    ...
    const animate = () => {
      ...
      if (titleRef.current) {
        ...
        spansRef.current.forEach((span) => {
          ...
          const wght = weight ? Math.floor(getAttr(d, 200, 800)) : 400;
          const alphaVal = alpha ? getAttr(d, 0, 1).toFixed(2) : 1;
          
          span.style.opacity = alphaVal.toString();
          
          span.style.fontVariationSettings = `'wght' ${wght}, 'wdth' ${wdth}, 'slnt' ${italic ? -10 : 0}`;
        });
      }
